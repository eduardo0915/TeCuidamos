...
@Component({
  ...
  templateUrl: './discapacidades.page.html',
  styleUrls: ['./discapacidades.page.scss'],
})
export class DiscapacidadesPage implements OnInit {
...
async loadDiscapacidades() {
  ...
  this.firestoreService.getCollection<Discapacidades>(path).subscribe( res => {
         console.log(res);
        this.discapacidade = res;
        console.log(this.discapacidade);
  });
}
